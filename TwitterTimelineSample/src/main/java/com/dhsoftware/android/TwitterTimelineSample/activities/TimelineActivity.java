...
import com.dhsoftware.android.TwitterTimelineSample.fragment.TimelineFragment;
import com.dhsoftware.android.TwitterTimelineSample.fragment.TwitterLoginFragment;
...
public class TimelineActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.com_dhsoftware_android_timelineActivity_container, mTimelineFragment, __TIMELINE_FRAGMENT_TAG__).commit();
        }
