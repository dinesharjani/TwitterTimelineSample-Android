 ...
 * <br></br>
 * One simple note: We're using Android's {@link SharedPreferences} to save our OAuth Token information. This is NOT
 ...
 * so to use {@link SharedPreferences} some sort of encryption would be recommended. There are many solutions for this
...
public final class TwitterHelper {
    ...
    /**
     * Simple getter method taking care of accessing {@link SharedPreferences} for recovering our current
     * OAuth Token.
     */
    ...
    /**
     * Just as the {@link TwitterHelper#getToken(Context context) getToken()} method, this one interfaces
     * with {@link SharedPreferences} and returns our current OAuth Token's TokenSecret value.
     */
    ...
    /**
     * This method only exists to make working with {@link SharedPreferences} easier in this class: it sets
    ...
    /**
     * The code for producing a new RequestToken which is represented by the {@link TwitterHelper#makeRequestToken(android.content.Context) requestToken()} method
     ...
     * an {@link AsyncTask} without the knowledge of the user (programmer) and we give them the Token through a callback interface defined by {@link IRequestTokenRequestCallback}.
     */
     ...
     * network, so it could make use of a similar strategy as the {@link TwitterHelper#getRequestToken(android.content.Context, IRequestTokenRequestCallback) getRequestToken()} method,
     ...
     * @param context a {@link Context} variable to access {@link SharedPreferences}, such as an {@link android.app.Activity Activity}.
     * @param requestToken the {@link RequestToken} the User used to get a PIN number from Twitter itself.
