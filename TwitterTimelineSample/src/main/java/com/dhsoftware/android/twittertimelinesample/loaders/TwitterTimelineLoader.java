...
public class TwitterTimelineLoader extends AsyncTaskLoader<ResponseList<Status>> {
    ...
    /**
     * For our Loader to work, we require a valid {@link twitter4j.auth.AccessToken} plus our own app's Consumer Key and Consumer
     * Secret. Note that this code is not "guarded" against null {@link twitter4j.auth.AccessToken}s.
     * @param accessToken a valid {@link twitter4j.auth.AccessToken}, in this sample code obtained through the {@link TwitterHelper} class.
     */
